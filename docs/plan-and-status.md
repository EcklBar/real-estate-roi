...
| הצגת מודעות (listings) בדשבורד | ✅ | טאב "New Listings", מסננים לפי מקור ועיר |
...
| דשבורד | KPIs, גרפים, עסקאות + טאב מודעות (stream_listings) | — |
| איכות/תיעוד | — | טסטים, README |

**הצעד הבא הממוקד:** טסטים או README (תיעוד הרצה).
